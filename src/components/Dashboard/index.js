...
export default class Dashboard extends Component {
	...
	componentDidMount() {
		axios
			.get('http://localhost:4000/customer/auth/me', this.state.config)
			.then((res) => {
			...
			<Wrapper>
				<div className='section-center'>
					<article className='header'>
						<h3>
							Welcome, {this.state.mydata.fname}
							<br />
						</h3>
						<p>
						...
						<article className='service'>
							...
							<div className='content'>
								<form onSubmit={(e) => e.preventDefault()}>
									<h3>
										{this.state.mydata.fname} {this.state.mydata.lname}
										<br />
									</h3>
